<footer class="bg-gradient-to-r from-gray-900 to-gray-800 text-white mt-16">
    <div class="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-8 text-sm">
        ...
        <!-- Brand -->
        <div>
            <h3 class="font-extrabold text-xl mb-3 tracking-wide">Awr Travel</h3>
            <p class="text-gray-400 leading-relaxed">
                Layanan transportasi travel Padang - Bukittinggi dengan kenyamanan dan keamanan terbaik.
            </p>
            <div class="flex gap-3 mt-5">
                <img src="{{ asset('img/google-play.png') }}" class="h-10 hover:scale-105 transition">
                <img src="{{ asset('img/app-store.png') }}" class="h-10 hover:scale-105 transition">
            </div>
        </div>
        ...
        <!-- Sosial Media -->
        <div>
            <h3 class="font-semibold text-lg mb-4 border-b border-gray-700 pb-2">Sosial Media</h3>
    ...
    <!-- Footer Bottom -->
    <div class="text-center text-gray-500 py-4 border-t border-gray-700 text-sm">
        &copy; 2025 <span class="font-semibold">Awr Travel</span>. Dibuat oleh <span class="text-white">M Wahyu Fikri</span>.
    </div>
</footer>
