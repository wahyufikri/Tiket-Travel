...
@endif
    ...
    <form action="/stop/{{ $routeStop->id }}" method="POST" class="bg-white p-6 rounded-lg shadow-md space-y-4">
        ...
        <!-- Urutan -->
        <div>
            <label for="stop_order" class="block font-semibold">Urutan Pemberhentian <span class="text-red-500">*</span></label>
        ...
        <!-- Nama Pemberhentian -->
        <div>
            <label for="stop_name" class="block font-semibold">Nama Pemberhentian <span class="text-red-500">*</span></label>
