...
<aside x-data="{ open: false, showLogoutConfirm: false }"
       class="w-64 h-screen bg-[#8B0000] text-white fixed flex flex-col">
    ...
    <!-- Footer -->
    <div class="px-4 py-4 border-t border-[#a83232]">
        ...
        <div x-show="open" x-transition x-cloak @click.away="open = false"
            ...
            <!-- Trigger Logout -->
            <button id="logoutBtn" type="button" class="w-full text-left px-4 py-2 text-sm hover:bg-[#a83232]">
                Logout
            </button>
        </div>
    </div>
